function DeltaH_CDS = Reaction_Enthalpy_CDS(T)
% This function calculates the CO2 splitting reaction enthalpy
% function of temperature
% Input:
% T - Temperature [K] (vector [1xN])
% Output:
% DeltaH_CDS - CO2 splitting reaction enthalpy [J/mol]
% Index:
% 1 - CO
% 2 - CO2
% 3 - O2
...
DeltaH_CDS = delta_H(1)+0.5*delta_H(3)-delta_H(2);
