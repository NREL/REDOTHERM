function [g_H2, g_H2O, g_O2] = Gibbs_energy_WS(T)
% This function calculates the Gibbs free energy of H2, H2O, and O2 as a
% function of temperature
% Input:
% T - Temperature [K] (vector [1xN])
% Output:
% g_H2 - Gibbs free energy of H2 [J/mol]
% g_H2O - Gibbs free energy of H2O [J/mol]
...
s_0 = [130.68; 188.84; 205.15];	% Standard entropy [J/mol-K]
